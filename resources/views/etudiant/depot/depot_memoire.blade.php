                    ...
                    <div class="table-responsive">
                        <table class="display" id="basic-1">
                            ...
                            <tbody>
                                ...
                                @if($stage->typeStage->date_limite_depot != null && $stage->typeStage->date_debut_depot
                                <= $current_date) <tr>
                                    <td>{{$stage->type_sujet}}</td>

                                    <td>{{ucwords($stage->enseignant->prenom)}} {{ucwords($stage->enseignant->nom)}}
                                    </td>
                                    <td>{{\App\Models\AnneeUniversitaire::find($stage->annee_universitaire_id)->annee}}
                                    </td>
                                    ...
                                    @elseif(\App\Models\DepotMemoire::where('stage_id',$stage->id)->first()->validation_encadrant
                                    == -1)
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-secondary btn-sm" data-toggle="tooltip"
                                            ...
                                            <a
                                                href="{{ route('remarques_encadrant',['depotMemoire'=> \App\Models\DepotMemoire::where('stage_id',$stage->id)->first()]) }}">
                                                <i class="icofont icofont-comment" style="color: white"></i>
                                            </a>
                                        </button>
                                    </td>
                                    @endif
                                    @elseif($stage->typeStage->date_limite_depot < $current_date) @if($stage->
                                        ...
                                        @elseif(($stage->depot_memoire_id == null) || ($stage->depot_memoire_id !== null
