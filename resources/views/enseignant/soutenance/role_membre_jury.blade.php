                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if($stnc->president_id==$ens->id)
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#{{$stnc->id}}"
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title">
                                                                Evaluer la soutenance
                                                                (Note
                                                                et
                                                                mention)</h5>
                                                            <button class="btn-close" type="button"
                                                                data-bs-dismiss="modal" aria-label="Fermez"></button>
                                                        </div>
                                                        <form method="POST"
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="col-md-12 position-relative">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <input class="touchspin" name="note" id="note"
                                                                ...
                                                                <div class="col-md-12 position-relative">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <input class="form-control" id="mention"
                                                                            name="mention" type="text" required disabled
                                                                            value="" />
                                                                    </div>
                                                                </div>
                                                                <input id="stnc" name="stnc" value="{{$stnc->id}}"
                                                                    type="hidden" />
                                                            </div>
...
@push('scripts') <script src="{{ asset('assets/js/touchspin/vendors.min.js') }}">
</script>
<script src="{{ asset('assets/js/touchspin/touchspin.js') }}"></script>
<script src="{{ asset('assets/js/touchspin/input-groups.min.js') }}"></script>
<script src="{{ asset('assets/js/datatable/datatables/jquery.dataTables.min.js') }}">
</script>
<script src="{{ asset('assets/js/datatable/datatables/datatable.custom.js') }}">
</script>
