                ...
                <div class="card">
                    <div class="card-header">
                        <h5>
                            ...
                            <strong> {{ ucwords($demande_depot->stage->etudiant->prenom) }} {{ ucwords($demande_depot->stage->etudiant->nom) }}</strong>
                        </h5>
                    </div>
                        ...
                        <div class="card-body filter-cards-view">
                            <div class="filter-view-group">
                                @foreach($commentaires as $commentaire)
                                    ...
                                    <span class="f-w-600"
                                          style="color: #2b786a">{{ucwords($commentaire->enseignant->prenom)}} {{ucwords($commentaire->enseignant->nom)}} </span>
                            ...
                            <div class="form theme-form">
                                <div class="row">
                                    <div class="col">
                                        <div class="text-end">
                                            <a class="btn btn-success me-3" href="{{ route('valider_depot',$demande_depot) }}">Valider le dépôt</a>
                                            <a class="btn btn-danger" onclick="toggleText()">Mettre à jour le
                                                dépôt
                                            </a>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col">
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" rows="3"
                                                          placeholder="écrivez vos remarques ici..." required
                                                          id="contenu" name="contenu"></textarea>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="mb-3">
