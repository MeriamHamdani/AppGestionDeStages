                    ...
                    <ul class="notification-dropdown onhover-show-div">
                        <li>
                            <p class="f-w-700 mb-0"> Vous
                                avez {{App\Models\Enseignant::where('user_id',auth()->id())->first()->notifications->count()}}
                                notifications
                                dont {{ App\Models\Enseignant::where('user_id',auth()->id())->first()->unreadNotifications->count()}}
                                non lus
                                ...
                                <li class="noti-secondary">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <a href={{ route('depots') }}>
                                        <span style="color: #ba895d"><strong>{{ $notification->data['nom_etud'] }} -
                                                {{ $notification->data['classe_etud'] }} a dépôsé son mémoire. Veuillez consulter la liste des demandes pour mettre votre décision</strong></span></a>
                                            <hr>
                                            <span>{{ $notification->data['date'] }}</span>
                                        </div>
                                    </div>
                                    ...
                                    <li class="noti-secondary">
                                        ...
                                        <span class="notification-bg bg-light-secondary"><i
                                            ...
                                            <div class="media-body">
                                                ...
                                                <a href={{ route('depots') }}>
                                        <span style="color: #ba895d"><strong>{{ $notification->data['nom_etud'] }} -
                                                {{ $notification->data['classe_etud'] }} a dépôsé son mémoire corrigé. Veuillez consulter la liste des demandes pour remettre votre décision</strong></span></a>
                                                <hr>
                                                <span>{{ $notification->data['date'] }}</span>
                                            </div>
                                        </div>
