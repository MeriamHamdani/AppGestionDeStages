...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <!-- Font Awesome-->
    @includeIf('layouts.enseignant.partials.css')
</head>
...
<div class="page-wrapper compact-sidebar" id="pageWrapper">
    <!-- Page Header Start-->
@includeIf('layouts.enseignant.partials.header')
<!-- Page Header Ends -->
    <!-- Page Body Start-->
    <div class="page-body-wrapper sidebar-icon">
        <!-- Page Sidebar Start-->
    @includeIf('layouts.enseignant.partials.sidebar')
    <!-- Page Sidebar Ends-->
        <div class="page-body">
...
<!-- latest jquery-->
@includeIf('layouts.enseignant.partials.js')
</body>
