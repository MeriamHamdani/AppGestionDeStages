            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="row g-3 needs-validation" novalidate="" method="POST"
                        action="{{ route('update_classe', $classe) }}">
                        @csrf
                        @method('PATCH')
                        @if($errors->any())
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="code" name="code" type="text"
                                        value="{{$classe->code}}" required placeholder="entrez le code de classe..." />
                                </div>
                            </div>
                            <div class="col">
                                <div class="mb-3">
                                    <label class="form-label" for="exampleFormControlInput1">Classe</label>
                                    <input class="form-control" id="nom" name="nom" type="text" value="{{$classe->nom}}"
                                        required placeholder="entrez le nom du classe..." />
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <select class="js-example-basic-single col-sm-12" id="niveau" name="niveau"
                                        ...
                                        <option value="1" {{ $classe->niveau == "1" ? 'selected' : '' }}>1 ère année
                                        </option>
                                        <option value="2" {{ $classe->niveau == "2" ? 'selected' : '' }}>2 ème année
                                        </option>
                                        <option value="3" {{ $classe->niveau == "3" ? 'selected' : '' }}>3 ème année
                                        </option>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="js-example-basic-single col-sm-12" id="cycle" name="cycle">
                                        <option disabled="disabled" selected="selected">Séléctionnez le cycle/type de
                                            formation</option>
                                        <option value="license" {{ $classe->cycle == "1" ? 'selected' : '' }}>Licence
                                        </option>
                                        <option value="master" {{ $classe->cycle == "2" ? 'selected' : '' }}>Mastère
                                        </option>
                                        <option value="doctorat" {{ $classe->cycle == "3" ? 'selected' : '' }}>Doctorat
                                        </option>
                                        <option value="ingeniorat" {{ $classe->cycle == "4" ? 'selected' : ''
                                            }}>Ingéniorat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <select class="js-example-basic-single col-sm-12" id="specialite_id"
                                        ...
                                        <option value="{{ $specialite->id }}" {{ old('specialite_id', $classe->
                                            specialite_id) == $specialite->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6 position-relative">
                            ...
                            <select class="js-example-basic-single col-sm-12" id="cycle" name="cycle">
                                ...
                                <option value="doctorat" {{ $classe->cycle == "doctorat" ? 'selected' : '' }}>Doctorat
                                </option>
                                <option value="ingenierie" {{ $classe->cycle == "ingenierie" ? 'selected' : ''
                                    }}>Ingénierie</option>
                            </select>
                        ...
                        <div class="col-md-6 position-relative">
                            ...
                            <select class="js-example-basic-single col-sm-12" id="specialite_id" name="specialite_id"
                                ...
                                @foreach(\App\Models\Specialite::all() as $specialite)
                                <option value="{{ $specialite->id }}" {{ old('specialite_id', $classe->specialite_id) ==
