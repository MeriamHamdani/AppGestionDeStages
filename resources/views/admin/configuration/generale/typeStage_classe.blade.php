...
<li class="breadcrumb-item active">configuration type de stage de la classe </li>
@endcomponent
                ...
                <div class="card-body">
                    <div class="stepwizard">
                        <div class="stepwizard-row setup-panel">
                            ...
                            @if($classe->niveau == 3 && $classe->cycle=="licence" ||$classe->niveau == 2 &&
                            $classe->cycle=="master" )
                    ...
                    <form class="row g-3 needs-validation" action="{{ route('typeStage.store',$classe) }}" method="POST"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input class="datepicker-here form-control digits date-picker" type="text"
                                            data-language="en" required="required" name="date_debut" id="date_debut"
                                    ...
                                    <div class="col-md-6 position-relative">
                                        ...
                                        <div class="input-group">
                                            <input class="touchspin" name="duree_stage_min" id="duree_stage_min"
                                                type="number" value="{{old('duree_stage_min')}}" required />
                                        </div>
                                    </div>
                                    <div class="col-md-6 position-relative">
                                        <label class="control-label">Durée de stage maximale en mois</label>
                                        <div class="input-group">
                                            <input class="touchspin" name="duree_stage_max" id="duree_stage_max"
                                                type="number" value="{{old('duree_stage_max')}}" required />
                                        </div>
                                    </div>
                                    <button class="btn btn-primary nextBtn pull-right" type="button">Suivant
                                    </button>
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="radio radio-primary">
                                                            <input id="radioinline1" type="radio"
                                                                name="fiche_demande_type" value="requis"
                                                                {{old('fiche_demande_type')=="requis" ? 'checked' : ''
                                                                }}>
                                                            <label class="mb-0" for="radioinline1">Requis</label>
                                                        </div>
                                                        <div class="radio radio-primary">
                                                            <input id="radioinline2" type="radio"
                                                                name="fiche_demande_type" value="non requis"
                                                                {{old('fiche_demande_type')=="non requis" ? 'checked'
                                                                : '' }}>
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="radio radio-primary">
                                                            <input id="radioinline3" type="radio"
                                                                name="fiche_assurance_type" value="requis"
                                                                {{old('fiche_assurance_type')=="requis" ? 'checked' : ''
                                                                }}>
                                                            <label class="mb-0" for="radioinline3">Requis</label>
                                                        </div>
                                                        <div class="radio radio-primary">
                                                            <input id="radioinline4" type="radio"
                                                                name="fiche_assurance_type" value="non requis"
                                                                {{old('fiche_assurance_type')=="non requis" ? 'checked'
                                                                : '' }}>
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="radio radio-primary">
                                                            <input id="radioinline5" type="radio"
                                                                name="fiche_2Dinars_type" value="requis"
                                                                {{old('fiche_2Dinars_type')=="requis" ? 'checked' : ''
                                                                }}>
                                                            <label class="mb-0" for="radioinline5">Requis</label>
                                                        </div>
                                                        <div class="radio radio-primary">
                                                            <input id="radioinline6" type="radio"
                                                                name="fiche_2Dinars_type" value="non requis"
                                                                {{old('fiche_2Dinars_type')=="non requis" ? 'checked'
                                                                : '' }}>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="mb-3 row">
                                                    <div
                                                        class="form-group m-t-15 m-checkbox-inline mb-0 custom-radio-ml">
                                                        <label class="col-sm-3 col-form-label">Le cahier de stage pour
                                                            ce type de stage est</label>
                                                        <div class="radio radio-primary">
                                                            <input id="radioinline7" type="radio"
                                                                name="cahier_stage_type" value="requis"
                                                                {{old('cahier_stage_type')=="requis" ? 'checked' : ''
                                                                }}>
                                                            <label class="mb-0" for="radioinline7">Requis</label>
                                                        </div>
                                                        <div class="radio radio-primary">
                                                            <input id="radioinline8" type="radio"
                                                                name="cahier_stage_type" value="non requis"
                                                                {{old('cahier_stage_type')=="non requis" ? 'checked'
                                                                : '' }}>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="d-block" for="chk-ani"><input class="checkbox_animated"
                                                id="chk-ani" type="checkbox" name="type_sujet[]" value="PFE">
                                            PFE</label>
                                    </div>
                                    <div class="form-group">
                                        <label class="d-block" for="chk-ani"><input class="checkbox_animated"
                                    ...
                                    <div class="form-group">
                                        <label class="d-block" for="chk-ani"><input class="checkbox_animated"
                                                id="chk-ani" type="checkbox" name="type_sujet[]" value="Business Plan">
                                            Business Plan</label>
                                        <button class="btn btn-secondary pull-right" type="submit">Términer!
                                        </button>
                                    </div>
