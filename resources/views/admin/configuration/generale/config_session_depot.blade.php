    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="f1" method="POST" action="{{ route('new_session_depot') }}"
                        ...
                        <fieldset>
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="d-block" for="f1-type-stage"><input class="checkbox_animated"
                                                id="f1-type-stage" type="checkbox" name="type_stages[]"
                                                value={{$ts->id}}>
                                            {{$ts->nom}}</label>
                                    </div>
                                </div>
                        ...
                        <fieldset>
                            <div class="form-group">
                                ...
                                <input class="datepicker-here form-control digits date-picker" name="date_debut_depot"
                                    id="f1-dat-debut" type="text" data-language="en" data-multiple-dates-separator=", "
                        ...
                        <fieldset>
                            <div class="form-group">
                                ...
                                <input class="datepicker-here form-control digits date-picker" name="date_limite_depot"
                                    id="f1-date-limite" type="text" data-language="en"
...
@elseif (Session::get('message')!="l'intervalle des dates est invalide" && Session::get('message')!="")
<script>
    swal('Oups',  'la configuration est échouée pour quelque(s) classe(s) selectionnée(s) \n Veuillez vérifier la date limite de depot' , 'error', {
                        button: 'Réssayer'
                    })
</script>
@endif
