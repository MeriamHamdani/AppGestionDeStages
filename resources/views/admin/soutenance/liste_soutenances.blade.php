                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form method="POST" action="{{ route('telecharger_pv_stnc') }}">
                                            ...
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    <label class="col-form-label" for="recipient-name">Selon la
                                                        Classe</label>
                                                    <div class="mb-2">
                                                        <select class="js-example-basic-single col-sm-12" id="classe_id"
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" class="btn btn-primary" type="button">Télécharger
                                                </button>
                                            </div>
                                        </form>
                                    </div>
                        ...
                        <table class="display" id="auto-fill">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <strong>Encadrant: </strong> {{ucwords($stage->enseignant->nom) }}
                                        {{ucwords($stage->enseignant->prenom) }}
                                        <strong>Président: </strong> {{ucwords($soutenance->president->nom) }}
                                        {{ucwords($soutenance->president->prenom) }}
                                        <strong>Rapporteur: </strong> {{ucwords($soutenance->rapporteur->nom) }}
                                        {{ucwords($soutenance->rapporteur->prenom) }}
                                    </td>
                                    <td style="font-size:8.5px">
                                        {{Arr::first((App\Http\Controllers\TypeStageController::decouper_nom($soutenance->date)))
                                        }}</td>
                                    ...
                                    <td class="text-center">
                                        <a href="{{route('telecharger_pv_indiv',$soutenance)}}"
                                            ...
                                            title="Télécharger le pv de la soutenance" data-toggle="tooltip"> <i
                                                class="icofont icofont-file-text icon-large"></i></a>
                                        @if($soutenance->stage->etudiant->classe->cycle == "licence" &&
                                        !(App\Http\Controllers\SoutenanceController::isInfo($soutenance->stage->etudiant->classe))
                                        )
                                        ...
                                        @elseif($soutenance->stage->etudiant->classe->cycle == "licence" &&
                                        (App\Http\Controllers\SoutenanceController::isInfo($soutenance->stage->etudiant->classe)))
