                        ...
                        <table class="display" id="auto-fill">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$stage->enseignant->nom }}&nbsp;{{$stage->enseignant->prenom }}</td>
                                    </td>
...
<<<<<<< HEAD <script src="{{asset('assets/js/datatable/datatables/jquery.dataTables.min.js')}}">
    </script>
    ...
    <script>
        swal({
                        position: 'center',
                        icon: 'info',
                        title: 'Il faut que l\'encadrant confirme la demande d\'abord'',
