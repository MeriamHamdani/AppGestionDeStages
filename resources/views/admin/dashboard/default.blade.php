                                ...
                                <table class="table table-bordernone">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="media"><img class="img-fluid rounded-circle"
                                                        src="{{asset('assets/images/dashboard/product-1.png')}}" alt=""
                                            ...
                                            <td><img class="img-fluid"
                                                    src="{{asset('assets/images/dashboard/graph-1.png')}}" alt=""
                                        ...
                                        <tr>
                                            <td>
                                                <div class="media"><img class="img-fluid rounded-circle"
                                                        src="{{asset('assets/images/dashboard/product-2.png')}}" alt=""
                                                        data-original-title="" title="">
                                            ...
                                            <td><img class="img-fluid"
                                                    src="{{asset('assets/images/dashboard/graph-2.png')}}" alt=""
                                                    data-original-title="" title=""></td>
                                            <td>
                                                <p>$548526</p>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="media"><img class="img-fluid rounded-circle"
                                                        src="{{asset('assets/images/dashboard/product-3.png')}}" alt=""
                                                        data-original-title="" title="">
                                            ...
                                            <td><img class="img-fluid"
                                                    src="{{asset('assets/images/dashboard/graph-3.png')}}" alt=""
                                                    data-original-title="" title=""></td>
                                            <td>
                                                <p>$589565</p>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="media"><img class="img-fluid rounded-circle"
                                                        src="{{asset('assets/images/dashboard/product-4.png')}}" alt=""
                                                        data-original-title="" title="">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="media"><img class="img-fluid rounded-circle"
                                                        src="{{asset('assets/images/dashboard/product-5.png')}}" alt=""
                                                        data-original-title="" title="">
