                ...
                <div class="error-page1">
                    ...
                    <form class="form theme-form needs-validation" method="POST"
                        ...
                        <div class="col-md-8 offset-md-2">
                            <h3>Veuillez changer votre mot de passe afin de pouvoir accédez à votre compte </h3>
                            <div class="row">
                                <p class="sub-content">la nouvelle mot de passe</p>
                                <div class="col-md-8 offset-md-2">
                                    <input class="form-control" type="password" name="new_password" id="motdepasse" />
                                    <!--<i class="far fa-eye" onclick="afficher()"></i>-->
                                </div>

                                <div class="col-md-8 offset-md-2"> <input type="checkbox"
                                        onclick="afficher()"><label>&nbsp;&nbsp;afficher le
                                        mot de passe</label></i>
                                </div>
                            </div>

                            <button class="btn btn-primary btn-lg" type="submit">Modifier</a>
                        </div>
                    </form>
                </div>
            </div>
