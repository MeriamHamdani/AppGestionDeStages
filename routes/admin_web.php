...
});Route::view('listDesEntreprise','admin.tables.ex-data-tables.listDesEntreprise')->name('listDesEntreprise');
...
Route::view('demandeAccepte', 'admin.errors.demandeAccepte')->name('demandeAccepte');
