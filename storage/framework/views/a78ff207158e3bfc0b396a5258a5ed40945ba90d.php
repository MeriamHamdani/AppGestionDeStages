      ...
      <div class="nav-right col pull-right right-menu p-0">
        <ul class="nav-menus">
          ...
          <li class="onhover-dropdown">
            <div class="bookmark-box"><i class="bookmark-icon" data-feather="inbox"></i></div
          </li>
          <li class="onhover-dropdown">
...
<?php /**PATH C:\laragon\www\essaiEnseignantTheme\resources\views/layouts/admin/partials/header.blade.php ENDPATH**/ ?>