	        ...
	        <div class="col-sm-12">
	            <div class="blog-single">
	                <div class="blog-box blog-details">
	                    <div class="banner-wrraper"><img class="img-fluid w-100 bg-img-cover" src="<?php echo e(asset('assets/images/blog/blog-single.jpg')); ?>" alt="blog-main" /></div>
	                    <div class="card">
	                        <div class="card-body">
	                ...
	                <div class="card comment-box">
	                    <div class="card-body">
	                        ...
	                        <ul>
	                            ...
	                            <li>
	                                <div class="media">
	                                    <img class="align-self-center" src="<?php echo e(asset('assets/images/blog/12.png')); ?>" alt="Generic placeholder image" />
	                                    <div class="media-body">
	                                        <div class="row">
	                                            <div class="col-md-4">
	                                                <a href="user-profile.html">
	                            ...
	                            <li>
	                                <div class="media">
	                                    <img class="align-self-center" src="<?php echo e(asset('assets/images/blog/14.png')); ?>" alt="Generic placeholder image" />
	                                    <div class="media-body">
	                                        <div class="row">
	                                            <div class="col-md-4">
	                                                <a href="user-profile.html">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\theme\resources\views/admin/miscellaneous/blog-single.blade.php ENDPATH**/ ?>