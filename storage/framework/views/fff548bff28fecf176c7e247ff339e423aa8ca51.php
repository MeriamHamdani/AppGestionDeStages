                    ...
                    <div class="card-header pb-0">
                        ...
                        <ul class="target-list">
                            <li class="bg-primary">
                                ...
                                <h3><?php echo e($nbre_stages); ?></h3>
                                <h4>Stages</h4>
                            </li>
                            <li class="bg-warning">
                                <i class="icofont icofont-hat-alt icon-4x"></i>
                                <h3><?php echo e($nbre_soutenances); ?></h3>
                                <h4>Soutenances</h4>
                            </li>
                            <li class="bg-secondary" style="width: 600px; text-align:center">
                                <i class="icofont icofont-architecture-alt icon-4x"></i>
                                <h3><?php echo e($nbre_entreprises); ?></h3>
                                <h4>Entreprises</h4>
                            </li>
...
<script type="text/javascript">
    var data2 = <?php echo json_encode($statVol); ?>;
...
<script type="text/javascript">
    var donnee = <?php echo json_encode($etdsLic); ?>;
...
<script type="text/javascript">
    var donnee2 = <?php echo json_encode($etdsMas); ?>;
...
<script type="text/javascript">
    var donn = <?php echo json_encode($tousEtds); ?>;
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\AppGestionDesStages\AppGestionDeStages\resources\views/admin/dashboard/dashboard.blade.php ENDPATH**/ ?>