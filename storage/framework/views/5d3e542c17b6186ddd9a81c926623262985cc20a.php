                    ...
                    <ul class="notification-dropdown onhover-show-div">
                        <!--<li>
                            <p class="f-w-700 mb-0"> Vous
                                avez
                                <?php echo e(App\Models\Enseignant::where('user_id',auth()->id())->first()->notifications->count()); ?>
                                ...
                                <div class="media-body">
                                    ...
                                    <a href=<?php echo e(route('liste_stages_actifs')); ?>>
                                        <strong style="color: #ba895d"><span>
                                                Le stage de l'étudiant <?php echo e($notification->data['etudiant']); ?> est
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <a href=<?php echo e(route('depots')); ?>>
                                        <span style="color: #ba895d"><strong><?php echo e($notification->data['nom_etud']); ?> -
                                                <?php echo e($notification->data['classe_etud']); ?> a dépôsé son mémoire. Veuillez
                        ...
                        <li class="noti-secondary">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <a href=<?php echo e(route('depots')); ?>>
                                        <span style="color: #ba895d"><strong><?php echo e($notification->data['nom_etud']); ?> -
                                                <?php echo e($notification->data['classe_etud']); ?> a dépôsé son mémoire corrigé.
                        ...
                        <?php endif; ?>
                        <?php if($notification->type==='App\Notifications\SoutenanceNotification'): ?>
                        <li class="noti-secondary">
                            <div class="media">
                                <span class="notification-bg bg-light-secondary"><i data-feather="user"> </i></span>
                                <div class="media-body">
                                    <p>
                                        planification de soutenance: <?php echo e($notification->data['post']); ?>
                                    ...
                                    <span style="color: #ba895d"><strong> Vous etes affecter comme <?php echo e($notification->data['post']); ?> d'une soutenance.
...
<?php /**PATH C:\laragon\www\AppGestionDesStages\AppGestionDeStages\resources\views/layouts/enseignant/partials/header.blade.php ENDPATH**/ ?>