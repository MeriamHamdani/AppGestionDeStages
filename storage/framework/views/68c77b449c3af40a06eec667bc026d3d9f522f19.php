                ...
                <tr>
                    <td>
                        <table align="center" border="0" cellpadding="0" cellspacing="0">
                            <tbody>
                                <tr>
                                    <td><img src="<?php echo e(asset('assets/images/email-template/delivery.png')); ?>" alt="" style="margin-bottom: 30px;" /></td>
                                </tr>
                                <tr>
                                    <td>
                        ...
                        <table class="order-detail" border="0" cellpadding="0" cellspacing="0" align="left">
                            <tbody>
                                ...
                                <tr>
                                    <td><img src="<?php echo e(asset('assets/images/email-template/4.png')); ?>" alt="" width="130" /></td>
                                ...
                                <tr>
                                    <td><img src="<?php echo e(asset('assets/images/email-template/1.png')); ?>" alt="" width="130" /></td>
                                    <td valign="top" style="padding-left: 15px;">
                                        <h5 style="margin-top: 15px;">Three seater Wood Style sofa for Leavingroom</h5>
                                    </td>
                                    <td valign="top" style="padding-left: 15px;">
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" align="left" style="width: 100%; margin-top: 30px; margin-bottom: 30px;">
                            <tbody>
                                <tr>
                                    ...
                                    <td class="user-info" width="57" height="25"><img src="<?php echo e(asset('assets/images/email-template/space.jpg')); ?>" alt=" " height="25" width="20" /></td>
                                    <td style="background-color: #fafafa; padding: 15px; letter-spacing: 0.3px; width: 50%;">
                                        <h5 style="font-size: 16px; font-weight: 600; color: #000; line-height: 16px; padding-bottom: 13px; border-bottom: 1px solid #e6e8eb; letter-spacing: -0.65px; margin-top: 0; margin-bottom: 13px;">
                                            SHIPPING ADDRESS
                                        </h5>
...
<?php /**PATH C:\laragon\www\theme\resources\views/admin/email/email-order-success.blade.php ENDPATH**/ ?>