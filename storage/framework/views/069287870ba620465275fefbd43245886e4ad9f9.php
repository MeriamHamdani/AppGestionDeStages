            ...
            <div id="mainnav">
                <ul class="nav-menu custom-scrollbar">
                    ...
                    <li class="dropdown">
                        ...
                        href="<?php echo e(route('demandes')); ?>" class="<?php echo e(routeActive('demandes')); ?>"><i class="icofont icofont-listine-dots" ></i>&nbsp&nbsp&nbsp<span>La liste des demandes d'encadrement</span></a>
...
<?php /**PATH C:\Users\Lenovo\gestionDesStages\resources\views/layouts/enseignant/partials/sidebar.blade.php ENDPATH**/ ?>