            ...
            <ul class="nav-menus">
                <li class="onhover-dropdown">
                    ...
                    <ul class="notification-dropdown onhover-show-div">
                        <li>
                            <p class="f-w-700 mb-0"> Vous avez <?php echo e(App\Models\Enseignant::where('user_id',auth()->id())->first()->notifications->count()); ?> notifications dont <?php echo e(App\Models\Enseignant::where('user_id',auth()->id())->first()->unreadNotifications->count()); ?> non lus
                        ...
                        <li class="noti-primary">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <a href=<?php echo e(route('liste_demandes')); ?>><span><?php echo e($notification->data['nom_etud']); ?> -
                                            <?php echo e($notification->data['classe_etud']); ?></span></a>
                                    <hr>
...
<?php /**PATH C:\laragon\www\AppGestionDeStages\resources\views/layouts/enseignant/partials/header.blade.php ENDPATH**/ ?>