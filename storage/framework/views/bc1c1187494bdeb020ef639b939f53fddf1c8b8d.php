...
&lt;/div&gt;</code></pre>
                ...
                <div class="col-xl-6 col-md-3 col-sm-6 box-col-3 des-xl-25 rate-sec">
                    <div class="card income-card card-primary">
                        <div class="card-body text-center">
                            <div class="round-box">
                                <i class="icofont icofont-ui-user-group" style="font-size: 3em;"></i>
                            </div>
                            <!--<h5>8,50,49</h5>-->
                            <p>Etudiants en Licence</p><a class="btn-arrow arrow-primary" href="javascript:void(0)"><i
                                    class="toprightarrow-primary fa fa-arrow-up me-2"></i>300 </a>
                            <div class="parrten">
                ...
                <div class="col-xl-6 col-md-3 col-sm-6 box-col-3 des-xl-25 rate-sec">
                    ...
                    <div class="card income-card card-secondary">
                        <div class="card-body text-center">
                            ...
                            <p>Etudiants en mastère</p><a class="btn-arrow arrow-secondary" href="javascript:void(0)"><i
                                    class="toprightarrow-secondary fa fa-arrow-up me-2"></i>150 </a>
                            <div class="parrten">
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="col-xl-6 col-md-3 col-sm-6 box-col-3 des-xl-25  rate-sec">
                    <div class="card income-card card-primary">
                        <div class="card-body text-center">
                            ...
                            <!--<h5>8,50,49</h5>-->
                            <p>Elève Ingenieur</p><a class="btn-arrow arrow-primary" href="javascript:void(0)"><i
                                    class="toprightarrow-primary fa fa-arrow-up me-2"></i>75 </a>
                            <div class="parrten">
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                    xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                    viewbox="0 0 448.057 448.057" style="enable-background:new 0 0 448.057 448.057;"
                            ...
                            <div class="header-top d-sm-flex align-items-center">
                                ...
                                <div class="center-content">
                                    <p class="d-flex align-items-center"><i
                                            class="toprightarrow-primary fa fa-arrow-up me-2"></i>80% Growth</p>
                                </div>
                                ...
                                <table class="table table-bordernone">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="media"><img class="img-fluid rounded-circle"
                                                        src="<?php echo e(asset('assets/images/dashboard/product-1.png')); ?>" alt=""
                                            ...
                                            <td><img class="img-fluid"
                                                    src="<?php echo e(asset('assets/images/dashboard/graph-1.png')); ?>" alt=""
                                        ...
                                        <tr>
                                            <td>
                                                <div class="media"><img class="img-fluid rounded-circle"
                                                        src="<?php echo e(asset('assets/images/dashboard/product-2.png')); ?>" alt=""
                                                        data-original-title="" title="">
                                            ...
                                            <td><img class="img-fluid"
                                                    src="<?php echo e(asset('assets/images/dashboard/graph-2.png')); ?>" alt=""
                                                    data-original-title="" title=""></td>
                                            <td>
                                                <p>$548526</p>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="media"><img class="img-fluid rounded-circle"
                                                        src="<?php echo e(asset('assets/images/dashboard/product-3.png')); ?>" alt=""
                                                        data-original-title="" title="">
                                                    <div class="media-body"><a href="#"><span>Beautiful Golden Tree
                                                                plant</span></a></div>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td><img class="img-fluid"
                                                    src="<?php echo e(asset('assets/images/dashboard/graph-3.png')); ?>" alt=""
                                                    data-original-title="" title=""></td>
                                            <td>
                                                <p>$589565</p>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="media"><img class="img-fluid rounded-circle"
                                                        src="<?php echo e(asset('assets/images/dashboard/product-4.png')); ?>" alt=""
                                                        data-original-title="" title="">
                                            ...
                                            <td><img class="img-fluid"
                                                    src="<?php echo e(asset('assets/images/dashboard/graph-4.png')); ?>" alt=""
                                                    data-original-title="" title=""></td>
                                            <td>
                                                <p>$125424 </p>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="media"><img class="img-fluid rounded-circle"
                                                        src="<?php echo e(asset('assets/images/dashboard/product-5.png')); ?>" alt=""
                                                        data-original-title="" title="">
                                                    <div class="media-body"><a href="#"><span>Being Human Branded
                                                                T-Shirt </span></a></div>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td><img class="img-fluid"
                                                    src="<?php echo e(asset('assets/images/dashboard/graph-5.png')); ?>" alt=""
                                                    data-original-title="" title=""></td>
                                            <td>
                                                <p>$112103</p>
                                            </td>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Lenovo\Desktop\stageApp\AppGestionDeStages\resources\views/admin/dashboard/default.blade.php ENDPATH**/ ?>