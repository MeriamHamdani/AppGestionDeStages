                ...
                <ul class="nav-menu custom-scrollbar">
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title link-nav" <?php echo e(prefixActive('etudiant/stage')); ?>
                            ...
                            href="<?php echo e(route('demandes_stages')); ?>" class="<?php echo e(routeActive('demandes_stages')); ?>">
                            <i class="icofont icofont-tasks-alt"></i>&nbsp&nbsp&nbsp<span>Mes demandes de stage</span></a>
                    </li>
                    <li class="dropdown">
                        <a class="nav-link menu-title link-nav" <?php echo e(prefixActive('etudiant/stage')); ?>

                            href="<?php echo e(route('demander_stage')); ?>"  class="<?php echo e(routeActive('demander_stage')); ?>"><i
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title link-nav" <?php echo e(prefixActive('etudiant/soutenance')); ?>
                            ...
                            href="<?php echo e(route('liste_soutenances')); ?>" class="<?php echo e(routeActive('liste_soutenances')); ?>"><i
...
<?php /**PATH C:\laragon\www\AppGestionDeStages\resources\views/layouts/etudiant/partials/sidebar.blade.php ENDPATH**/ ?>