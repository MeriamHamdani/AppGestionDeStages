...
<?php $__env->startSection('title'); ?>Liste des demandes des stages obligatoires pour 3ème année licence informatique
<?php echo e($title); ?>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><a
                                            href="<?php echo e(route('telechargement_fiche_demande',['fiche_demande'=>$stage->file,'code_classe'=>$stage->code_classe])); ?>">
                                    ...
                                    <td class="text-center">
                                        <?php if($stage->confirmation_admin!=1): ?>
                                        <a href="<?php echo e(route('confirmer_demande',['stage_id'=>$stage->id])); ?>"> <i
                                                data-toggle="tooltip" title="Confirmer"
                                                class="icofont icofont-ui-check icon-large"></i></a>
                                        <?php endif; ?>
                                        <?php if($stage->confirmation_admin!=-1): ?>
                                        <a href="<?php echo e(route('refuser_demande',['stage_id'=>$stage->id])); ?>"><i
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\AppGestionDeStages\resources\views/admin/stage/listes_demandes_stage/so3Info.blade.php ENDPATH**/ ?>