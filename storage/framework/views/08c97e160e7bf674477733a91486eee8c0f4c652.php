...
<?php $__env->startSection('title'); ?>Décision sur le dépôt
<?php echo e($title); ?>
...
<h3>Mettre votre décision sur le dépôt de
    : <?php echo e(ucwords($demande_depot->stage->etudiant->prenom)); ?> <?php echo e(ucwords($demande_depot->stage->etudiant->nom)); ?></h3>
<?php $__env->endSlot(); ?>
            ...
            <div class="card">
                <div class="card-header">
                    <h5>
                        ...
                        <strong> <?php echo e(ucwords($demande_depot->stage->etudiant->prenom)); ?> <?php echo e(ucwords($demande_depot->stage->etudiant->nom)); ?></strong>
                    </h5>
                </div>
                <div class="collapse show" id="collapseicon2" aria-labelledby="collapseicon2" data-parent="#accordion">
                    ...
                    <div class="card-body filter-cards-view">
                        <div class="filter-view-group">
                            ...
                            <span class="f-w-600" style="color: #2b786a"><?php echo e(ucwords($commentaire->enseignant->prenom)); ?>

                                <?php echo e(ucwords($commentaire->enseignant->nom)); ?> </span>
                            <p style="color: #0c0c0c">
                                <?php echo e($commentaire->contenu); ?>

                            </p>
                            <p class="f-w-600"> <?php echo e($commentaire->created_at); ?></p> <br>
                                ...
                                <div class="col">
                                    <div class="text-end">
                                        <a class="btn btn-success me-3"
                                            href="<?php echo e(route('valider_depot',$demande_depot)); ?>">Valider le mémoire</a>
                                        <a class="btn btn-danger" onclick="toggleText()">Mettre à jour le mémoire
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <form method="POST" action="<?php echo e(route('refuser_depot',$demande_depot)); ?>">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.enseignant.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\AppGestionDesStages\AppGestionDeStages\resources\views/enseignant/depot/details_depot.blade.php ENDPATH**/ ?>