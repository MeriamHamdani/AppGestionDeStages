                ...
                <ul class="nav-menu custom-scrollbar">
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title link-nav <?php echo e(routeActive('dashboard')); ?>"
                            href="<?php echo e(route('dashboard')); ?>" ><i
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title link-nav  <?php echo e(in_array(Route::currentRouteName(),
                            ['config_annee_universitaire','modifier_annee_universitaire']) ? 'active' : ''); ?>" <?php echo e(routeActive('liste_annee_universitaire')); ?>"
                            href="<?php echo e(route('liste_annee_universitaire')); ?>">
