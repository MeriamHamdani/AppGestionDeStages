        ...
        <div class="main-navbar">
            ...
            <div id="mainnav">
                <ul class="nav-menu custom-scrollbar">
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title link-nav <?php echo e(prefixActive('/admin/stage/demandes-stage')); ?>">
                            <i class="icofont icofont-listing-box"></i>&nbsp&nbsp&nbsp<span>Les demandes de
                                stages</span></a>
                        <ul class="nav-submenu menu-content" style="display: <?php echo e(prefixBlock('/admin/stage/demandes-stage')); ?>;">
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title link-nav <?php echo e(routeActive('liste_classes')); ?>"
                           href="<?php echo e(route('liste_classes')); ?>">
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title <?php echo e(prefixActive('/admin/configuration/generale')); ?>">
                            <i class="icofont icofont-university"></i>&nbsp&nbsp&nbsp<span>Configuration
                                générale</span></a>
                        <ul class="nav-submenu menu-content" style="display: <?php echo e(prefixBlock('/admin/configuration/generale')); ?>;">
...
<?php /**PATH C:\Users\Lenovo\Desktop\stageApp\AppGestionDeStages\resources\views/layouts/admin/partials/sidebar.blade.php ENDPATH**/ ?>