                ...
                <li>
                    <form class="form-inline search-form">
                        <div class="search-bg"><i class="fa fa-search"></i>
                            <input class="form-control-plaintext" placeholder="Cherchez ici...">
                        </div>
                    </form>
...
<?php /**PATH C:\laragon\www\gestionDesStages\resources\views/layouts/etudiant/partials/header.blade.php ENDPATH**/ ?>