<?php $__env->startSection('title'); ?>Demande en cours
<?php echo e($title); ?>
        ...
        <div class="container">
            <div class="error-page1">
                ...
                <div class="col-md-8 offset-md-2">
                    <h3>Votre demande de stage est en cours de traitement ...</h3>
                    <p class="sub-content">La direction de stage est en train de traiter votre demande,veuillez
                        patientez s'il vous plaît</p>
                    <!--<a class="btn btn-primary btn-lg" href="<?php echo e(route('index')); ?>" disabled>Accueil</a>-->
                </div>
            </div>
        </div>
    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\essaiEtudiantTheme\resources\views/admin/errors/error-page1.blade.php ENDPATH**/ ?>