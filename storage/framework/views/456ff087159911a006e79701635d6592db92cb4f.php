        ...
        <div class="nav-right col pull-right right-menu p-0">
            <ul class="nav-menus">
                ...
                <li class="onhover-dropdown p-0">
                    <!--<button class="btn btn-primary-light" type="button"><a href=<?php echo e(route('deconnexion')); ?>><i data-feather="log-out"></i></a>Déconnecter</button>
-->
...
<?php /**PATH C:\laragon\www\AppGestionDeStages\resources\views/layouts/admin/partials/header.blade.php ENDPATH**/ ?>