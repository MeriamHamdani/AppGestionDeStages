                            ...
                            <div class="media">
                                ...
                                <div class="media-body d-block">
                                    ...
                                    <ul class="timeline-pro">
                                        <li><img class="img-fluid" src="<?php echo e(asset('assets/images/dashboard-2/11.png')); ?>"
                                                 alt="Product-1"></li>
                                        <li><img class="img-fluid" src="<?php echo e(asset('assets/images/dashboard-2/10.png')); ?>"
                                                 alt="Product-2"></li>
                                    </ul>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\AppGestionDesStages\AppGestionDeStages\resources\views/admin/dashboard/dashboard-02.blade.php ENDPATH**/ ?>