                ...
                <tr>
                    <td>
                        ...
                        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tbody>
                                <tr>
                                    <td><img src="<?php echo e(asset('assets/images/email-template/1.jpg')); ?>" alt="" style="width: 100%;" /></td>
                                </tr>
                            </tbody>
                        </table>
                                ...
                                <tr>
                                    <td>
                                        <div class="product-box hover">
                                            <div class="product border-theme br-0"><img src="<?php echo e(asset('assets/images/email-template/2.png')); ?>" alt="product" style="width: 100%;" /></div>
                                    ...
                                    <td>
                                        <div class="product-box hover">
                                            <div class="product border-theme br-0"><img class="img-fluid" src="<?php echo e(asset('assets/images/email-template/7.png')); ?>" alt="product" /></div>
                                            <div class="product-info">
                                    ...
                                    <td>
                                        <div class="product-box hover">
                                            <div class="product border-theme br-0"><img class="img-fluid" src="<?php echo e(asset('assets/images/email-template/8.png')); ?>" alt="product" /></div>
                                            <div class="product-info">
                                                <div class="rating"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i></div>
                                                <a href="javascript:void(0)" tabindex="0" style="text-align: center;"> <h6 style="text-align: center;">When an unknown.</h6></a>
                                                <h4 style="text-align: center;">$45.00</h4>
                        ...
                        <table class="main-bg-light" border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top: 40px;">
                            <tbody>
                                ...
                                <tr class="add-with-banner" align="center">
                                    <td><img src="<?php echo e(asset('assets/images/email-template/3.png')); ?>" /></td>
                                    <td>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tbody>
                                <tr align="center">
                                    <td>
                                        <a href="javascript:void(0)"><img src="<?php echo e(asset('assets/images/email-template/cosmetic.jpg')); ?>" style="width: 100%;" /></a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top: 30px;">
                            <tbody>
                                <tr class="add-with-banner" align="center">
                                    <td>
                                        <a href="javascript:void(0)"><img src="<?php echo e(asset('assets/images/email-template/6.png')); ?>" style="width: 100%;" /></a>
                                    </td>
                                    <td>
                                        <a href="javascript:void(0)"><img src="<?php echo e(asset('assets/images/email-template/5.png')); ?>" style="width: 100%;" /></a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
...
<?php /**PATH C:\laragon\www\theme\resources\views/admin/email/template-email.blade.php ENDPATH**/ ?>