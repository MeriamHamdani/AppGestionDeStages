<header class="main-nav">
    <div class="sidebar-user text-center">
        ...
        <a href="">
            <h6 class="mt-3 f-14 f-w-600"><?php echo e(ucwords(App\Models\Enseignant::where('user_id',auth()->id())->first()->prenom)); ?>

                <?php echo e(ucwords(App\Models\Enseignant::where('user_id',auth()->id())->first()->nom)); ?></h6>
        </a>
        <p class="mb-0 font-roboto" style="color: #ba895d"><strong><?php echo e(ucwords(App\Models\Enseignant::where('user_id',auth()->id())->first()->grade)); ?></strong> </p>
        <p class="mb-0 font-roboto" style="color: #ba895d"><strong><?php echo e(ucwords(App\Models\Enseignant::where('user_id',auth()->id())->first()->departement->nom)); ?></strong> </p>
        ...
        <div class="main-navbar">
            ...
            <div id="mainnav">
                <ul class="nav-menu custom-scrollbar">
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title link-nav  <?php echo e(routeActive('depots')); ?>"
                           href="<?php echo e(route('depots')); ?>">
                    ...
                    <li class="dropdown">
                        ...
                        <a class="nav-link menu-title link-nav link-nav  <?php echo e(routeActive('role_encadrant')); ?>"
                           href="<?php echo e(route('role_encadrant')); ?>">
                            <i class="icofont icofont-teacher"></i>&nbsp&nbsp&nbsp<span>En tant qu'Encadrant</span></a>

                    </li>
                    <li class="dropdown">
                        <a class="nav-link menu-title link-nav <?php echo e(routeActive('role_membre_jury')); ?>"
                           href="<?php echo e(route('role_membre_jury')); ?>">
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title link-nav <?php echo e(routeActive('liste_stages_paye')); ?>" href="<?php echo e(route('liste_stages_paye')); ?>">
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title link-nav <?php echo e(routeActive('liste_stages_non_paye')); ?>" href="<?php echo e(route('liste_stages_non_paye')); ?>">
