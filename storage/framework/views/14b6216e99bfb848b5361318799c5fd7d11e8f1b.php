                                ...
                                <?php $__currentLoopData = $demandes_classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $demande): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <?php if(isset($demande->enseignant->prenom)): ?>
                                            <td><?php echo e(ucwords($demande->enseignant->prenom)); ?> <?php echo e(ucwords($demande->enseignant->nom)); ?></td>
                                        <?php else: ?>
                                            <td class="text-center">
                                                <i class="icofont icofont-exclamation-tringle"
                                                   style="font-size: 1.3em"></i>
                                        ...
                                        <td>
                                            <?php if($demande->confirmation_admin == 0): ?>
                                                ...
                                                <?php if($demande->confirmation_encadrant == -1): ?>
                                                    ...
                                                    <button class="btn btn-warning btn-sm"> <a href="<?php echo e(route('modifier_demande',['stage_id'=>$demande->id])); ?>"
...
<?php echo $__env->make('layouts.etudiant.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Lenovo\Desktop\stageApp\AppGestionDeStages\resources\views/etudiant/stage/demandes_stages.blade.php ENDPATH**/ ?>