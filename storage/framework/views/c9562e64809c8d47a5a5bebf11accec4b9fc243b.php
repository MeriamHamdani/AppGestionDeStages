        ...
        <div class="main-navbar">
            ...
            <div id="mainnav">
                <ul class="nav-menu custom-scrollbar">
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title link-nav <?php echo e(routeActive('demander_stage')); ?>"
                            href="<?php echo e(route('demander_stage')); ?>"><i
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title link-nav <?php echo e(routeActive('liste_entreprises')); ?>" href="<?php echo e(route('liste_entreprises')); ?>"><i
                                class="icofont icofont-list"></i>&nbsp&nbsp&nbsp<span>La liste des
                                entreprises</span></a>
                    </li>
                    <li class="dropdown">
                        <a class="nav-link menu-title link-nav <?php echo e(routeActive('ajouter-entreprise')); ?>" href="<?php echo e(route('ajouter-entreprise')); ?>"><i
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title link-nav <?php echo e(routeActive('depot')); ?>" href="<?php echo e(route('depot')); ?>">
