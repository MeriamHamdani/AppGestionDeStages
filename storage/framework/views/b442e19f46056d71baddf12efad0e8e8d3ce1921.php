<header class="main-nav">
    <div class="sidebar-user text-center">
        ...
        <p class="mb-0 font-roboto" style="color: #ba895d"><strong><?php echo e(ucwords(App\Models\Etudiant::where('user_id',auth()->id())->latest()->first()->classe->code)); ?></strong> </p>
            ...
            <div id="mainnav">
                <ul class="nav-menu custom-scrollbar">
                    ...
                    <li class="dropdown">
                        ...
                        <?php echo e(routeActive('soutenance_etudiant')); ?>"
                            href="<?php echo e(route('soutenance_etudiant')); ?>"><i
...
<?php /**PATH C:\laragon\www\AppGestionDesStages\AppGestionDeStages\resources\views/layouts/etudiant/partials/sidebar.blade.php ENDPATH**/ ?>