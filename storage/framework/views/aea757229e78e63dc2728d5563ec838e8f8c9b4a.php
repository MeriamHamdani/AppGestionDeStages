            ...
            <ul class="nav-menus">
                <li class="onhover-dropdown">
                    ...
                    <ul class="notification-dropdown onhover-show-div">
                        <li>
                            <p class="f-w-700 mb-0"> Vous avez <?php echo e(App\Models\Etudiant::where('user_id',auth()->id())->first()->notifications->count()); ?> notifications dont
                        ...
                        <?php $__currentLoopData = App\Models\Etudiant::where('user_id',auth()->id())->first()->notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
