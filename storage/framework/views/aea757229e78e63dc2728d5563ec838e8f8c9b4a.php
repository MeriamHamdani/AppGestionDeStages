            ...
            <ul class="nav-menus">
                <li class="onhover-dropdown">
                    ...
                    <ul class="notification-dropdown onhover-show-div">
                        <li>
                            <p class="f-w-700 mb-0"> Vous avez <?php echo e(App\Models\Etudiant::where('user_id',auth()->id())->latest()->first()->notifications->count()); ?> notifications dont
                                <?php echo e(App\Models\Etudiant::where('user_id',auth()->id())->first()->unreadNotifications->count()); ?> non lus

                                <!--<span class="pull-right badge badge-primary badge-pill">4</span>-->
                            </p>
                        </li>
                        <?php $__currentLoopData = App\Models\Etudiant::where('user_id',auth()->id())->latest()->first()->notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($notification->type==='App\Notifications\DownloadLettreAffectationNotification'): ?>
                                ...
                                <li class="noti-secondary">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <a href=<?php echo e(route('liste_stages')); ?>>
                            ...
                            <?php endif; ?>
                            <?php if($notification->type=='App\Notifications\EncadrementAccepteNotifiaction'): ?>
                                <li class="noti-secondary">
                                    <div class="media">
                                        <span class="notification-bg bg-light-secondary"><i
                                                data-feather="activity"> </i></span>
                            ...
                            <?php endif; ?>
                                <?php if($notification->type=='App\Notifications\EncadrementRefuseNotifiaction'): ?>
                                    <li class="noti-secondary">
                                        <div class="media">
                                        <span class="notification-bg bg-light-secondary"><i
                                                data-feather="activity"> </i></span>
                                ...
                                <?php endif; ?>
                                <?php if($notification->type=='App\Notifications\DemandeStageRefuseNotification'): ?>
                                    <li class="noti-secondary">
                                        <div class="media">
                                ...
                                <?php endif; ?>
                            <?php if($notification->type=='App\Notifications\SessionDepotOuverteNotification'): ?>
                                <li class="noti-secondary">
                                    <div class="media">
                                        <span class="notification-bg bg-light-secondary"><i
                                                data-feather="activity"> </i></span>
                                        ...
                                        <span style="color: #ba895d"><strong>
                                                La session de dépôt dure de <?php echo e($notification->data['date_debut_depot']); ?>

                                            jusqu'à  <?php echo e($notification->data['date_limite_depot']); ?></strong> </span>
                                            <hr>
                                            <span><?php echo e($notification->data['date']); ?></span>
                                        </div>
                                    </div>
                            ...
                            <?php endif; ?>
                                <?php if($notification->type=='App\Notifications\SessionDepotModifieNotification'): ?>
                                    <li class="noti-secondary">
                                        <div class="media">
                                        <span class="notification-bg bg-light-secondary"><i
                                                data-feather="activity"> </i></span>
                                            <div class="media-body">
                                                ...
                                                <span style="color: #ba895d"><strong>
                                                La session de dépôt a subit des modifications au niveau des dates, le nouvel intervalle: <?php echo e($notification->data['date_debut_depot']); ?> à
                                          <?php echo e($notification->data['date_limite_depot']); ?></strong> </span>
                                                <hr>
                                                <span><?php echo e($notification->data['date']); ?></span>
                                            </div>
                                        </div>
                                ...
                                <?php endif; ?>
                                <?php if($notification->type==='App\Notifications\DepotMemoireValideParEncadrantNotification'): ?>
                                ...
                                <?php endif; ?>
                                <?php if($notification->type==='App\Notifications\DepotMemoireValideParAdminNotification'): ?>
                                ...
                                <?php endif; ?>
                                <?php if($notification->type==='App\Notifications\DepotMemoireRefuseParEncadrantNotification'): ?>
                                ...
                                <?php endif; ?>
                                <?php if($notification->type==='App\Notifications\DepotMemoireRefuseParAdminNotification'): ?>
...
<?php /**PATH C:\laragon\www\AppGestionDesStages\AppGestionDeStages\resources\views/layouts/etudiant/partials/header.blade.php ENDPATH**/ ?>